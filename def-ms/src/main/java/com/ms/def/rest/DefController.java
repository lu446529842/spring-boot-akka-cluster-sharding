...
public class DefController {
    ...
    @RequestMapping(value = "/event/to/self", method = RequestMethod.POST)
    @ResponseBody
    public  void postEventToSelf(@RequestBody AssignmentEvent assignmentEvent,HttpServletRequest request){
        System.out.println("Controller : Dispatching to self");
        eventDispatcher.dispatchToSelf(assignmentEvent);
    }
