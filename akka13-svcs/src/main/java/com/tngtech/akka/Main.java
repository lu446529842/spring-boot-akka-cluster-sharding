...
public class Main {
  ...
  public static void main( String[] args ) throws Exception {
    ...
    //Pumps in scheduled ticks every sec to TaskCreator Actor for the duration of 200 milli seconds.
  ...
  public static class TaskCreator extends UntypedActor {
    ...
    public void onReceive( Object message ) throws Exception {
      if ( message instanceof Tick ) {
        ...
        Service.Response r=(Service.Response) message;
        log.info( "Received response" +r.getTask().toString());
      }
    }
