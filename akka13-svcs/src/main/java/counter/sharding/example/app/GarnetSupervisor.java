 ...
 */
public class GarnetSupervisor extends UntypedActor {
    ...
    private void initActor(){
        ...
        // is unavailable
        counter = getContext().watch(getContext().actorOf(Props.create(CounterSupervisor.class), "CounterSupervisor"));
...
//                    return restart();
                    ...
                    System.out.println("Garnet supervisor, Final else restartOrEsclate strategy, escalate");
                    return restart();
                }
            }
        });
    ...
    public SupervisorStrategy supervisorStrategy() {
        System.out.println("Garnet superviosr Supervisor strategy invoked.");
